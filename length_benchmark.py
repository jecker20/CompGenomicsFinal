...
def parse_args():
    ...
    parser.add_argument('-l', '--length', required=True, help="read length")
    parser.add_argument('-n', '--number', required=True, help="number of reads")
    parser.add_argument('-f', '--files', required=True, help="number of files")
    parser.add_argument('-r', '--repeats', required=True, help="repeats per files")
